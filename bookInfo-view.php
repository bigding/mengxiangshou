                        ...
                        <table class="table table-bordered data-table">
                            ...
                            while ($row1 = mysqli_fetch_array($result1)) {
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-success btn-mini infoDelete"   data-id="'.$row1['bId'].'" data-type="bId" data-sql="book"   data-id="' . $row1['bId'] . '"  data-original-title="删除信息">删除</a><!--删除做成ajax请求-->
                                </td>
                            </tr>
                                ';
                            }
